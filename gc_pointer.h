...
Pointer<T,size>::Pointer(T *t){
    ...
    //if the pointer is in the list then increment its refcount
    if(ptr_info_it!=refContainer.end()){
        ++ptr_info_it->refcount;
    } else{
        //if it is not in the list then add it to the end
...
Pointer<T, size>::~Pointer(){
    ...
    auto ptr_info_it=findPtrInfo(addr);
